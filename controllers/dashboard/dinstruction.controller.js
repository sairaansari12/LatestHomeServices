...
/**
*@role Delete Special Instruction
*/
...
app.get('/cancel',adminAuth, async (req, res, next) => {
  try {
      ...
      return res.render('admin/ordersetting/cancel.ejs',{findData});
    } catch (e) {
      return responseHelper.error(res, e.message, 400);
    }
});
...
*/
app.post('/cancel/addReason',adminAuth,async (req, res) => {
  try {
    const data = req.body;
...
*/
app.get('/cancel/delete/:id',adminAuth,async(req,res,next) => { 
  ...
  try{
    ...
    req.flash('successMessage',appstrings.delete_success)
    return res.redirect(adminpath+"ordersetting/cancel");
  }catch (e) {
    req.flash('errorMessage',appstrings.no_record)
    return res.redirect(adminpath+"offers");
  }
...
*/
app.post('/cancel/updateReason',adminAuth,async (req, res) => {
  try {
    const data = req.body;
    //Update Instruction
